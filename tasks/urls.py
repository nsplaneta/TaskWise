...
from . import views
from .views import CreateProductView, ProductListView, TaskListView, SaleListView, change_password, edit_contact, create_company, create_individual, index, create_task, product_delete, settings_contact_list, task_detail, delete_task, sale_detail, create_sale, edit_sale, delete_sale, contact_list, contact_detail, settings_view, update_user_info
...
urlpatterns = [
    ...
    path('individuals/<int:id>/', edit_contact, {'contact_type': 'individual'}, name='edit_individual'),
    path('companies/<int:id>/', edit_contact, {'contact_type': 'company'}, name='edit_company'),
    ...
    path('contacts/individual/create/', create_individual, name='create_individual'),
    ...
    path('settings/products/', ProductListView.as_view(), name='product_list_settings'),
    path('settings/products/<int:id>/', views.product_detail, name='product_detail_settings'),
    path('settings/edit_products/<int:id>/', views.product_settings, name='product_settings'),
    path('settings/delete_product/', product_delete, name='product_delete'),  
    path('settings/product/create/', CreateProductView.as_view(), name='create_product'),
